...
<body>
	<ol class="breadcrumb">
		...
		<li class="active">前端设备审核</li>
	</ol>

	<form action="batchHandlePredevice" method="post">
		<div class="tables">
			<div class="row">
				<div class="batch-btn">
					<span>批 量 操 作</span>
				...
				<div class="col-xs-12">
					<div class="table-header">前端设备审核</div>
					<div class="table-responsive">
						<table id="sample-table-2"
							...
							<tbody>
								<s:if test="#session.auditDevice.size()>0">
									<s:iterator value="#session.auditDevice" status="st" id="pdl">
										...
										<tr>
											...
											<td>
												<a href="ManagerPassdevice.action?id=<s:property value="#pdl.auditid"/>"><input type="button" class="btn btn-info" value="通过"></a> 
												<a href="ManagerRefuseddevice.action?id=<s:property value="#pdl.auditid"/>"><input type="button" class="btn btn-danger" value="拒绝"></a> 
												<a href="PredeviceDetailOfAuditing.action?id=<s:property value="#pdl.auditid"/>"><input type="button" class="btn btn-success" value="查看详情"></a></td>
										</tr>
									</s:iterator>
								</s:if>
