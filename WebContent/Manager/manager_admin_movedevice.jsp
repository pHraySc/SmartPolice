				...
				<div class="col-xs-12">
					...
					<div class="table-responsive">
						<table id="sample-table-2" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<s:if test="#session.allMoveDevice.size()>0">
										<s:iterator value="#session.allMoveDevice" status="st" id="pdl">
											...
											<tr>
												...
												<td><a href="MovedeviceDetailOfManager.action?id=<s:property value="#pdl.auditid"/>"><input type=button class="btn btn-success" value="查看详情" /></a></td>
											</tr>
										</s:iterator>
									</s:if>
							</tbody>
