        ...
        <!-- Content -->
 		<div id="content">
            ...
            <form method="post" action="#" name="form">
                ...
                <tbody>
                		<s:if test="#session.allsoft.size()>0">
							<s:iterator value="#session.allsoft" status="st" id="pdl">
								<tr>
			                		...
			                		<td><s:property value="#pdl.version"/></td>
			                		<td><s:property value="#pdl.username"/></td>
			                		<td><input type="button" class="btn" value="已审核/未审核"></td>
			                		<td><a href="firmAdminSoftInfo.action?id=<s:property value="#pdl.softid"/>"><input type=button class="btn btn-success" value="查看详情" /></a></td>
								</tr>
