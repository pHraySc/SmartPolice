...
<body>
	...
	<div id="container">
		...
		<!-- Content -->
		<div id="content">
			<h2 class="top-title">设备信息上传</h2>
			&nbsp;&nbsp;&nbsp;<span style="color: red" id="msg"></span>
			<form onsubmit="return checkInput();" method="post" action="f_uploadPredeviceinfo.action" enctype="multipart/form-data">
				<div class="clear"></div>
				<!-- Clear floatting -->
				<table class="list-table" id="equip">
					<tbody>
						<tr>
							<td>设备名称</td>
							<td><input id="plugname" type="text" name="plugname" /></td>
						</tr>
						<tr>
							<td>设备序列号</td>
							<td><input id="uploadPerson" type="text" name="uploadPerson" /></td>
						</tr>
						<tr>
							<td>设备类型</td>
							<td><select id="checkSelect" name="plugtype">
									<option value="0">感应监控器</option>
									<option value="1">图形监控器</option>
							</select></td>
						</tr>
						<tr>
							<td>上传设备</td>
						...
						<tr>
							<td>设备描述</td>
							<td><textarea id="plugversion" type="text" name="plugversion"></textarea></td>
						</tr>
					</tbody>
				</table>
