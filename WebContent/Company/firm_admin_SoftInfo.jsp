...
<body>
	...
	<div id="container">
		...
		<!-- Content -->
		<div id="content">
			<h2 class="top-title">软件详细信息</h2>
			<form method="post" action="#" name="form">
			<s:if test="#session.softInfo.size()>0">
							<s:iterator value="#session.softInfo" status="st" id="pdl">
				...
				<table class="list-table">
					<tbody>
						<tr>
							...
							<td width="60">软件序列号:</td>
							<td width="350"><s:property value="#pdl.serial"/></td>
						</tr>
						<tr>
							<td>软件MD5码:</td>
							<td><s:property value="#pdl.md5"/></td>
							<td>软件大小:</td>
							<td><s:property value="#pdl.size"/></td>
						</tr>

						<tr>
							<td>软件存放地址:</td>
							<<td><s:property value="#pdl.url"/></td>
						</tr>
								</s:iterator>
                		</s:if>
					</tbody>
			...
			<a href="../Company/firm_Admin_Soft.jsp"><input type="button" class="btn" value="返回"/></a>
			<hr />
			<!-- Divider -->
